...
namespace Recon
{
    public class objectrecon : GH_Component
    {
        #region
        public objectrecon()
            : base("CAD recognizer", "CAD recognizer", "CAD recognizer", "Extra", "CADrecon")
        {
        }
        ...
        {
            get { return new Guid("933a03f6-80dc-4468-9b04-5b6f7b365030"); }
        }
        ...
        private List<rep> AllCandidates = new List<rep>();
        private dataobject known = new dataobject();
        ...
        // Origional Function to compare point maps 
        //private List<Point3d> pointmapcompare2(List<double> goodmap,List<ptlist> unkownpts, List<rep>  unknownmap)
        //{
        ...
        //        {
        //            List<cadgeo> all = unknownmap.ElementAt(i);
        //            //unkown pts is the list of 4 possible mirrored candidate points
        //            //derived from the xform function
        //            //each ptlist contains 4 points. there are M ptlists- one for each object.
        //            foreach (ptlist pl in unkownpts)
        //            {
        //                foreach (Point3d pt in pl)
        //                {
        //                    // foreach candidate point, 
        //                  //  var testmap = ptdistmap(all, pt);
        //                    double distancet = ptdistsum(all, pt);

        //                 //   bool mapisEqual = isequal(goodmap, testmap);
        //                 //   if (mapisEqual == true)
        //                 //   {
        //                        final.Add(pt);
        //                   //     break;
        ...
        // Final Function to compare point maps 
        ...
        //
        //BODY CONTAINS THE SEARCH FUNCTIONS
        //

        //TESTING New function for comparing distancemaps with a given tolerence // TESTING
        //private bool isequal(List<double> knownm, List<double> distmap)
        //{
        //    bool mapsame = false;
        //    int counter = 0;
        //    for (int j = 0; j < knownm.Count; j++) //foreach (double dk in knownm)
        //    {
        //        bool hasone = false;
        //      //  int counterlocal = 0;
 
        //       for (int i = 0 ; i < distmap.Count ; i++) // foreach (double du in distmap)
        //        {
        //            double diff1 = distmap.ElementAt(i) + 1;
        //            double diff2 = distmap.ElementAt(i) - 1;
        //            if (Math.Abs(distmap.ElementAt(i) - knownm.ElementAt(j)) < 2)
        //            {
        //              //  counterlocal++;
        //                knownm.ElementAt(j);
        //               // distmap.RemoveAt(i);
        ...
        //                break;
        //            }
        //         //   if (hasone == true) { break; }
        //        }

        //       if (hasone == true)//  if (counter == knownm.Count)
        //        {
        //            counter++;
        //        }
        //    }
        ...
        //                        foreach (dmap knownm in known.dmap)
        //                        {
        //                           // bool mapisEqual = new HashSet<double>(knownm).SetEquals(distmapt); // MODIFY TOLERANCE ORIGONAL
        //                            bool mapisEqual = isequal(knownm, distmapt);
   ...
   // A = d;
    ...
    public class rep : List<cadgeo>
    {
        ...
        public GH_Line bestfitline { get; set; }
        public GH_Line translatedline { get; set; }
        public Plane repplane { get; set; }
        public Line vector { get; set; }
        public rep() { }
    }

    public class ptlist : List<Point3d>
    {
         public ptlist() { }
    }
